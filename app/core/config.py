...
# =============================================================================
# Centralised settings loaded once from environment / .env files.
# =============================================================================
...
class Settings(BaseSettings):
    ...
    odoo_database_url_sync: PostgresDsn | None = None
    ...
    redis_pubsub_url: RedisDsn = Field(default="redis://redis:6379/1")
    ...
    # AWS Rekognition, loaded from D:\CODE\Python\ai-camera-system\.env locally
